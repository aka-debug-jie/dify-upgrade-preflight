...
机器真相：`catalog/support-matrix.yaml`。当前 owner 审批的 exact edge 为 `1.16.0 → 1.16.1` 与 `1.13.1 → 1.13.2`，并由 `catalog/approval-manifest.yaml` 绑定。P05 仍待最终阶段验收；尚未完成独立真实升级重演或真实维护者反馈，不能声称 production-grade 或升级安全保证。
